...
exports.seed = function (knex, Promise) {
  return knex('posts').insert([
    ...
    { contents: "Not-knowing is true knowledge. Presuming to know is a disease.", user_id: 1 },
    { contents: "Success or failure: which is more destructive?", user_id: 1 },
    { contents: "When two great forces oppose each other the victory will go to the one that knows how to yield.", user_id: 1 },
    { contents: "Things arise and she let's them come; things disappear and she let's them go.", user_id: 1 },
    { contents: "Beware of the barrenness of a busy life.", user_id: 2 },
    { contents: "I cannot reach anybody anything. I can only make them think.", user_id: 2 },
    { contents: "True knowledge exists in knowing that you know nothing.", user_id: 2 },
